...
class BagOfWords(corpus_processing):
    ...
    def create_bag_of_words(self):
        ...
        bag_of_words = self.vectorizer.fit_transform([' '.join(filtered_tokens)])
        return bag_of_words.toarray(), self.vectorizer.get_feature_names_out()  
if __name__ == "__main__":
    bow = BagOfWords(paragraph)
    bag_of_words, feature_names = bow.create_bag_of_words()
